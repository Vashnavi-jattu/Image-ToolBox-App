...
SECRET_KEY = 'django-insecure-r#6bbu3pr91-=5-h0qx+nn=omve%5(m$e=-$iaqa)qqbn(t4o#'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:8081",  # Django dev server
    "http://192.168.0.125:8081",  # Your mobile testing IP
]
TEMPLATES = [
    {
